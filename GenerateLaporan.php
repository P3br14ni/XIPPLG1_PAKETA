        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="Peminjaman.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Peminjaman</a>
                    <a href="GenerateLaporan.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Generate Laporan</a>
                    <div class="nav-item dropdown">
                    </div>
                </div>
            </nav>
